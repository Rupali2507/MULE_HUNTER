...
A full-spectrum platform for detecting **mule accounts and collusive fraud** using
graph intelligence, real-time systems, security analytics, and explainable AI.

This project is built to demonstrate **enterprise-grade engineering**, not just models.
...
System architecture, data flow, and demo narrative.  
_No code lives here._
